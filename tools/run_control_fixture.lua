...
local function checkControllerTerms()
    ...
    local translationTerms = machines.controller.translation:terms()
    ...
    assert(terms.horizontal == translationTerms.horizontal, "controller should compose horizontal terms from translation")
    assert(terms.vertical == translationTerms.vertical, "controller should compose vertical terms from translation")
